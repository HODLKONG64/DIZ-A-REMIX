...
describe("SWARMSY runtime chat flow wiring", () => {
  it("passes pending runtime handoff from chat container into stream execution", () => {
    ...
    expect(source).toContain("buildSwarmsyIntakeProgress");
    expect(source).toContain("SwarmsyOnboarding.saveIntakeProgress");
    expect(source).toContain("void saveSwarmsyIntakeAnswer(currentMessage)");
