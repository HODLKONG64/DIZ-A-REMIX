...
- a beginner-first home screen with three plain starting choices, no duplicated saved-work choice, and internal knowledge status kept out of the main path;
